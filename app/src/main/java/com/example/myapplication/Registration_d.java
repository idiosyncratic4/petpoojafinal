...
public class Registration_d extends AppCompatActivity {
    ...
    private void validate(String fName, String lName, String Address, String Contact, String uid,String pwd, String sq_qstn, String sq_ansr){
        ...
        new SigninActivity2Register_d_insert(this,Info).execute(fName,lName,Address, Contact, uid, pwd, sq_qstn, sq_ansr);
