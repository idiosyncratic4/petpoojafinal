...
public class SigninActivity2Login_a extends AsyncTask {
    ...
    protected Object doInBackground(Object[] objects) {
        ...
        try{
            ...
            String link="http://10.0.2.2:80/f123/Login_a.php";
    ...
    public SigninActivity2Login_a(Context context, TextView statusField) {
    ...
    protected void onPostExecute(Object result){
        ...
        if(this.statusField.getText().equals(" found"))
        {
            ...
            Intent i=new Intent(this.context,Home_a.class);
