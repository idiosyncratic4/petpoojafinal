...
public class SigninActivity2Register_insert extends AsyncTask {
    ...
    protected Object doInBackground(Object[] objects) {
        ...
        try {
            ...
            String link = "http://10.0.2.2:80/f123/insert_regist.php";
    ...
    public SigninActivity2Register_insert(Context context, TextView statusField) {
    ...
    protected void onPostExecute(Object result) {
        ...
        if (this.statusField.getText().equals(" Registered_Successfully  ")) {
